...
public class HttpRequestClient {
    ...
    private static ResponseEntity<Object> getGatewayResponse(ResponseEntity<Object> response) {
    ...
    protected ResponseEntity<Object> get(String path, @Nullable Map<String, Object> parameters) {
        return sendRequest(HttpMethod.GET, path, 0L, parameters, null);
    }
    ...
    protected <T> ResponseEntity<Object> put(String path, long userId, @Nullable Map<String, Object> parameters, T body) {
        return sendRequest(HttpMethod.PUT, path, userId, parameters, body);
    }
    ...
    protected ResponseEntity<Object> delete(String path, Long userId, @Nullable Map<String, Object> parameters) {
        return sendRequest(HttpMethod.DELETE, path, userId, parameters, null);
    }
    ...
    private <T> ResponseEntity<Object> sendRequest(HttpMethod method, String path, Long userId, @Nullable Map<String, Object> parameters, @Nullable T body) {
        HttpEntity<T> requestEntity = new HttpEntity<>(body, getHeaders(userId));
        ...
        return getGatewayResponse(shareitServerResponse);
    }
